/**
 * Custom error classes for Grid SDK
 *
...
export class OrderNotFoundError extends GridError {
  constructor(message: string = 'Order not found', public orderId?: string) {
...
export class MarketNotFoundError extends GridError {
  constructor(message: string = 'Market not found', public marketId?: string) {
...
export class WebSocketError extends GridError {
  constructor(message: string, public wsCode?: number) {
    super(message, 'WEBSOCKET_ERROR', { wsCode });
